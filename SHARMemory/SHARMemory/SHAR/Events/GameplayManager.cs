...
public class MissionChangedEventArgs : EventArgs
{
    ...
    public MissionChangedEventArgs(Classes.Mission lastMission, Classes.Mission newMission)
    {
...
public class MissionStageChangedEventArgs : EventArgs
{
    ...
    public MissionStageChangedEventArgs(MissionStage lastStage, MissionStage newStage)
    {
        LastStage = lastStage;
        NewStage = newStage;
    }
