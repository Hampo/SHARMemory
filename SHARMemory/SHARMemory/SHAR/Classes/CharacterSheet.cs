...
namespace SHARMemory.SHAR.Classes
{
    public class CharacterSheet : Class
    {
        ...
        public bool CardCollected(uint Level, uint Card) => ReadByte(16 + 620 * Level + 17 * Card + 16) != 0;

        public string MissionName(uint Level, uint Mission) => ReadString(16 + 620 * Level + 120 + 32 * Mission, Encoding.ASCII, 16u);

        public bool MissionCompleted(uint Level, uint Mission) => ReadByte(16 + 620 * Level + 120 + 32 * (Level == 0 ? Mission + 1 : Mission) + 16) != 0;

        public string StreetRaceName(uint Level, uint StreetRace) => ReadString(16 + 620 * Level + 120 + 256 + 32 * StreetRace, Encoding.ASCII, 16u);

        public bool StreetRaceCompleted(uint Level, uint StreetRace) => ReadByte(16 + 620 * Level + 120 + 256 + 32 * StreetRace + 16) != 0;

        public string BonusMissionName(uint Level) => ReadString(16 + 620 * Level + 120 + 256 + 96, Encoding.ASCII, 16u);

        public bool BonusMissionCompleted(uint Level) => ReadByte(16 + 620 * Level + 120 + 256 + 96 + 16) != 0;

        public string GambleRaceName(uint Level) => ReadString(16 + 620 * Level + 120 + 256 + 96 + 32, Encoding.ASCII, 16u);

        public bool GambleRaceCompleted(uint Level) => ReadByte(16 + 620 * Level + 120 + 256 + 96 + 32 + 16) != 0;

        public bool FMVUnlocked(uint Level) => ReadByte(16 + 620 * Level + 120 + 256 + 96 + 32 + 32) != 0;
        ...
        public bool IsNavSystemEnabled => ReadByte((uint)(16 + 620 * Memory.LevelCount + 16)) != 0;
