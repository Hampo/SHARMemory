...
public struct PMD : IEquatable<PMD>
{
    ...
    public override readonly string ToString() => $"{MDisp} | {PDisp} | {VDisp}";
    ...
    public readonly bool Equals(PMD other)
    {
    ...
    public override readonly bool Equals(object obj) => obj is PMD pmd && Equals(pmd);
